...
energy <- read_csv("C:/Users/Moritz/Desktop/projects/DBS-Projekt/data/original_data/change-energy-consumption.csv")
...
gdp <- eq_names(gdp, country) %>% select(-"Country Name")
p_growth <- eq_names(p_growth, country) %>% select(-"Country Name")
